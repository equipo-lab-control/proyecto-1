...
Td = simplify( wn_d^2 / ( s^2 + 2*zeta_d*wn_d*s+wn_d^2 ))    %transferencia deseada
...
Td_polo_extra = expand( wn_d^2 / ( ( s^2 + 2*zeta_d*wn_d*s+wn_d^2 ) * (s - polo_adicional) ))    
...
eq1 = Ke * Kc / (J * L * ti) == den_simplified(1)
eq2 = (b * R + Ke^2 + Ke * Kc) / (J * L) == den_simplified(2)
eq3 = (J * R + b * L + Ke * Kc * td) / (J * L) == den_simplified(3)
